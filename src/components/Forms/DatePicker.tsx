...
> {
  ...
  defaultMonth?: Date;
  formatValue?: (
    value: Date | DateRangeValue | undefined,
    mode: DatePickerMode,
  ) => string;
}
...
const calendarClassNames = {
  ...
  weekday:
    "text-center text-[10px] font-bold tracking-[0.14em] text-foreground-subtle uppercase",
...
export const DatePicker = React.forwardRef<HTMLButtonElement, DatePickerProps>(
  (props, ref) => {
    ...
    >({
      ...
      onChange: (nextValue) => {
        if (mode === "range") {
          (props as DatePickerRangeProps).onValueChange?.(
            nextValue as DateRangeValue | undefined,
          );
        } else {
          (props as DatePickerSingleProps).onValueChange?.(
          ...
          >
            ...
            <span
              className={cn(
                ...
                selectedValue ? "text-foreground" : "text-foreground-subtle",
              )}
            >
              {displayValue}
            </span>
              ...
              >
                {mode === "range" ? (
                  <DayPicker
                    ...
                    excludeDisabled={
                      (props as DatePickerRangeProps).excludeDisabled
                    }
                    resetOnSelect={
                      (props as DatePickerRangeProps).resetOnSelect
                    }
