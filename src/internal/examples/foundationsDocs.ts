...
export const sizeModeCssExample = [
  ...
  createCssRule(
    'html[data-size-mode="comfortable"]',
    sizeModeCssVariables.comfortable,
  ),
].join("\n\n");
...
export const consumerThemeOverrideCssExample = [
  ...
  createCssRule(
    'html[data-size-mode="compact"]',
    sizeModeCssVariables.compact,
  ),
  createCssRule(
    'html[data-size-mode="default"]',
    sizeModeCssVariables.default,
  ),
  createCssRule(
    'html[data-size-mode="comfortable"]',
...
export const typographyFontFamilies = Object.entries(
  ...
  sample:
    name === "mono"
      ? "NODE_ALPHA_001 - 0x1F4A3B"
      : "The quick brown fox jumps over the lazy dog",
}));

export const typographyFontSizes = Object.entries(
...
export const typographyFontWeights = Object.entries(
...
export const radiusTokens = Object.entries(designTokens.radius).map(
  ([name, radius]) => ({
    name,
    radius,
  }),
